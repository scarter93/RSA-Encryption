proc AddWaves {} {
    ...
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/latch_in
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/mont_mult_1/data_ready
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/latch_in2
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/mont_mult_2/data_ready	
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/sqr_mult/count
    add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/state		
    ;#add wave -radix unsigned -position end sim:/modular_exponentiation_tb/dut/sqr_mult/count	
